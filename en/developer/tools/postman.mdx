...
<Steps>
  <Step title="After importing the Postman collection, click “Environments” in the top-right corner">
  </Step>
  <Step title="Select “Test Environment”">
  </Step>
  <Step title="Enter your actual test keys into the `secret_key` and `public_key` variables">
  </Step>
  <Step title="Save and activate the environment">
  </Step>
</Steps>
