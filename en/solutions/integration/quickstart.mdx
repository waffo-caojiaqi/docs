...
<Steps>
  <Step title="Register a Waffo merchant account and complete KYB verification">
  </Step>
  <Step title="Obtain the sandbox API Key in the Merchant Portal">
  </Step>
  <Step title="Choose the integration method that fits you best (hosted checkout / embedded components / direct API integration)">
  </Step>
  <Step title="Follow the corresponding integration documentation to complete development">
  </Step>
  <Step title="Complete end-to-end testing in the sandbox environment">
  </Step>
  <Step title="Switch to the production API Key and go live">
  </Step>
</Steps>
